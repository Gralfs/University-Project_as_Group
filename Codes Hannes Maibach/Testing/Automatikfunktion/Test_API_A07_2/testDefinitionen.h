...
licht=150;  // Eigene Testimplementierung...
...
Serial.print(location);}
  ...
  "Test des Richtwertevergleichs zu den Umweltszenarien mit anschließendem Anpassen der Rolloposition, hier: Nacht/Dämmerung (A07/A08)", "testDefinitionen.h");
}
